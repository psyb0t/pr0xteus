...
func renderEnvFile(
	...
	lines := []string{
		...
		"PR0XTEUS_HTTP_PROXY_HOST_PORT=127.0.0.1:8080",
		"PR0XTEUS_SOCKS_PUBLIC_ADDRESS=127.0.0.1:1080",
		"PR0XTEUS_HTTP_PROXY_PUBLIC_ADDRESS=127.0.0.1:8080",
...
func renderEnvExample(
	...
	lines := []string{
		...
		"PR0XTEUS_HTTP_PROXY_HOST_PORT=127.0.0.1:8080",
		"",
		"# Addresses returned in allocated proxy URLs. Keep them aligned with reachable",
		"# host ports; do not use 0.0.0.0 here.",
		"PR0XTEUS_SOCKS_PUBLIC_ADDRESS=127.0.0.1:1080",
		"PR0XTEUS_HTTP_PROXY_PUBLIC_ADDRESS=127.0.0.1:8080",
		"",
